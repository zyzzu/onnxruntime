...
#define SPECIALIZED_BINARY_ELEMENTWISE_IMPL_UZILHFD_O(x) \
  SPECIALIZED_BINARY_ELEMENTWISE_IMPL_UZILHFD(x) \
...
SPECIALIZED_BINARY_ELEMENTWISE_IMPL_UZILHFD_O(Equal)
