...
#define BINARY_LOGICALOP_REGISTER_UZILHFD_O(name, ver) \
  BINARY_LOGICALOP_REGISTER_UZILHFD(name, ver)         \
  BINARY_ELEMENTWISE_LOGICALOP_REGISTER_KERNEL_TYPED(name, ver, bool)

#define BINARY_LOGICALOP_REGISTER_VERSIONED_OIL(name, startver, endver)               \
...
BINARY_LOGICALOP_REGISTER_VERSIONED_OIL(Equal, 7, 10)
BINARY_LOGICALOP_REGISTER_UZILHFD_O(Equal, 11)
