...
add_dependencies(onnxruntime_providers ${onnxruntime_EXTERNAL_DEPENDENCIES})
...
if (onnxruntime_USE_NGRAPH)
  ...
  add_dependencies(onnxruntime_providers_ngraph project_ngraph ${onnxruntime_EXTERNAL_DEPENDENCIES})
...
if (onnxruntime_USE_OPENVINO)
  ...
  if(MSVC)
    ...
    add_dependencies(onnxruntime_providers_openvino project_ngraph ${onnxruntime_EXTERNAL_DEPENDENCIES})
...
if (onnxruntime_USE_NNAPI_DNNLIBRARY)
  ...
  add_dependencies(onnxruntime_providers_nnapi dnnlibrary::dnnlibrary ${onnxruntime_EXTERNAL_DEPENDENCIES})
...
elseif (onnxruntime_USE_NNAPI_BUILTIN)
  ...
  add_dependencies(onnxruntime_providers_nnapi ${onnxruntime_EXTERNAL_DEPENDENCIES})
  set_target_properties(onnxruntime_providers_nnapi PROPERTIES CXX_STANDARD_REQUIRED ON)
  set_target_properties(onnxruntime_providers_nnapi PROPERTIES FOLDER "ONNXRuntime")
  target_include_directories(onnxruntime_providers_nnapi PRIVATE ${ONNXRUNTIME_ROOT} ${nnapi_INCLUDE_DIRS})
  set_target_properties(onnxruntime_providers_nnapi PROPERTIES LINKER_LANGUAGE CXX)
...
if (onnxruntime_USE_RKNPU)
  ...
  add_dependencies(onnxruntime_providers_rknpu ${onnxruntime_EXTERNAL_DEPENDENCIES})
